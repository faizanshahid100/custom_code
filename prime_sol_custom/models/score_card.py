...
class ScoreCard(models.Model):
    ...
    def _compute_cumulative_score(self):
        for record in self:
            active_weightage = self.env['score.weightage'].search([('is_active', '=', True), ('partner_id', '=', record.employee_id.contractor.id), ('department_id', '=', record.employee_id.department_id.id)])
